...
## Main Headline
- Stock Market Today: Tech Futures Sell Off On OpenAI Report; Broadcom, Micron, Nvidia Tumble (Live Coverage)
...
메인 헤드라인을 "Stock Market Today: Tech Futures Sell Off On OpenAI Report; Broadcom, Micron, Nvidia Tumble (Live Coverage)"로 고정하고 파생 뉴스 3개를 연결했습니다. 이 출력은 시황 해석 에이전트의 입력으로 넘어갑니다.
References: live-semiconductors-stock-market-today-tech-futures-sell-off-on-openai-report-broadcom-micron-nvidia, live-semiconductors-nvidia-stock-falls-what-s-hitting-amd-broadcom-and-the-ai-chip-players, live-semiconductors-openai-hit-a-speed-bump-here-s-why-nvidia-s-long-term-story-is-still-intact, live-semiconductors-amd-supplier-up-40-this-month-soars-on-earnings-beat

### 02 Macro Analyst -> Ticker Analyst
지금 시장은 반도체 리더십과 방어형 에너지로 자금이 압축되는 국면입니다. 이 해석은 티커 딥분석과 행동 제안 에이전트의 공통 컨텍스트가 됩니다.
References: live-semiconductors-stock-market-today-tech-futures-sell-off-on-openai-report-broadcom-micron-nvidia, live-semiconductors-nvidia-stock-falls-what-s-hitting-amd-broadcom-and-the-ai-chip-players, live-energy-oil-bp-profit-jumps-as-oil-trading-boomed-during-iran-war

### 03 Ticker Analyst -> Execution Trader
NVDA를 대표 분석 티커로 선택해 추세, 패턴, 섹터 연결을 해석했습니다. 이 출력은 행동 제안 에이전트가 진입/관망/회피 조건을 만드는 기준이 됩니다.
References: NVDA, live-semiconductors-stock-market-today-tech-futures-sell-off-on-openai-report-broadcom-micron-nvidia, live-semiconductors-nvidia-stock-falls-what-s-hitting-amd-broadcom-and-the-ai-chip-players, live-semiconductors-openai-hit-a-speed-bump-here-s-why-nvidia-s-long-term-story-is-still-intact
...
References: NVDA, live-semiconductors-nvidia-stock-falls-what-s-hitting-amd-broadcom-and-the-ai-chip-players, live-semiconductors-openai-hit-a-speed-bump-here-s-why-nvidia-s-long-term-story-is-still-intact, live-semiconductors-amd-supplier-up-40-this-month-soars-on-earnings-beat
