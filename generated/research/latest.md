...
메인 헤드라인을 "This Chip Stocks Rally Is Suddenly Fragile. Why Markets Should Worry."로 고정하고 파생 뉴스 3개를 연결했습니다. 이 출력은 시황 해석 에이전트의 입력으로 넘어갑니다.
References: live-semiconductors-this-chip-stocks-rally-is-suddenly-fragile-why-markets-should-worry, live-semiconductors-why-amd-s-ai-roadmap-is-very-competitive-with-nvidia-s, live-semiconductors-ouster-brings-rev8-native-color-lidar-to-the-nvidia-drive-hyperion-platform-for-, live-semiconductors-nvidia-stock-falls-after-report-ceo-huang-is-excluded-from-trump-s-china-trip

### 02 Macro Analyst -> Ticker Analyst
지금 시장은 반도체 리더십과 방어형 에너지로 자금이 압축되는 국면입니다. 이 해석은 티커 딥분석과 행동 제안 에이전트의 공통 컨텍스트가 됩니다.
References: live-semiconductors-this-chip-stocks-rally-is-suddenly-fragile-why-markets-should-worry, live-semiconductors-why-amd-s-ai-roadmap-is-very-competitive-with-nvidia-s, live-energy-oil-exxon-mobil-weighs-venezuela-reentry-against-valuation-and-dividend-concerns

### 03 Ticker Analyst -> Execution Trader
NVDA를 대표 분석 티커로 선택해 추세, 패턴, 섹터 연결을 해석했습니다. 이 출력은 행동 제안 에이전트가 진입/관망/회피 조건을 만드는 기준이 됩니다.
References: NVDA, live-semiconductors-this-chip-stocks-rally-is-suddenly-fragile-why-markets-should-worry, live-semiconductors-why-amd-s-ai-roadmap-is-very-competitive-with-nvidia-s, live-semiconductors-ouster-brings-rev8-native-color-lidar-to-the-nvidia-drive-hyperion-platform-for-
...
References: NVDA, live-semiconductors-why-amd-s-ai-roadmap-is-very-competitive-with-nvidia-s, live-semiconductors-ouster-brings-rev8-native-color-lidar-to-the-nvidia-drive-hyperion-platform-for-, live-semiconductors-nvidia-stock-falls-after-report-ceo-huang-is-excluded-from-trump-s-china-trip
