...
메인 헤드라인을 "Nvidia Sells the Shovels, Alphabet Digs the Mine: Two Paths to AI Dominance"로 고정하고 파생 뉴스 3개를 연결했습니다. 이 출력은 시황 해석 에이전트의 입력으로 넘어갑니다.
References: live-semiconductors-nvidia-sells-the-shovels-alphabet-digs-the-mine-two-paths-to-ai-dominance, live-semiconductors-salescloser-deepens-conversational-ai-moat-with-dedicated-gpu-inference-cluster-, live-semiconductors-dow-jones-futures-s-p-500-nasdaq-hold-near-highs-nvidia-walmart-earnings-loom, live-semiconductors-marvell-s-ai-partnerships-with-amd-google-and-amazon-test-lofty-valuation

### 02 Macro Analyst -> Ticker Analyst
지금 시장은 반도체 리더십과 방어형 에너지로 자금이 압축되는 국면입니다. 이 해석은 티커 딥분석과 행동 제안 에이전트의 공통 컨텍스트가 됩니다.
References: live-semiconductors-nvidia-sells-the-shovels-alphabet-digs-the-mine-two-paths-to-ai-dominance, live-semiconductors-salescloser-deepens-conversational-ai-moat-with-dedicated-gpu-inference-cluster-
...
References: NVDA, live-semiconductors-salescloser-deepens-conversational-ai-moat-with-dedicated-gpu-inference-cluster-, live-semiconductors-dow-jones-futures-s-p-500-nasdaq-hold-near-highs-nvidia-walmart-earnings-loom, live-semiconductors-marvell-s-ai-partnerships-with-amd-google-and-amazon-test-lofty-valuation
