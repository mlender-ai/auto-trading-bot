...
메인 헤드라인을 "Got 1,000 To Invest? Nvidia vs AMD- Only One Deserves Your Money"로 고정하고 파생 뉴스 3개를 연결했습니다. 이 출력은 시황 해석 에이전트의 입력으로 넘어갑니다.
References: live-semiconductors-got-1-000-to-invest-nvidia-vs-amd-only-one-deserves-your-money, live-semiconductors-sandisk-s-gross-margins-just-topped-nvidia-s-wall-street-sold-anyway, live-semiconductors-a-look-at-amd-amd-valuation-after-a-powerful-multi-period-share-price-run, live-semiconductors-chai-ai-backed-by-coreweave-and-amd-hits-80m-arr-with-talks-of-2-4b-valuation

### 02 Macro Analyst -> Ticker Analyst
지금 시장은 반도체 리더십과 방어형 에너지로 자금이 압축되는 국면입니다. 이 해석은 티커 딥분석과 행동 제안 에이전트의 공통 컨텍스트가 됩니다.
References: live-semiconductors-got-1-000-to-invest-nvidia-vs-amd-only-one-deserves-your-money, live-semiconductors-sandisk-s-gross-margins-just-topped-nvidia-s-wall-street-sold-anyway, live-energy-oil-chevron-exxon-edge-higher-as-q1-earnings-skid-but-outlook-shapes-up

### 03 Ticker Analyst -> Execution Trader
NVDA를 대표 분석 티커로 선택해 추세, 패턴, 섹터 연결을 해석했습니다. 이 출력은 행동 제안 에이전트가 진입/관망/회피 조건을 만드는 기준이 됩니다.
References: NVDA, live-semiconductors-got-1-000-to-invest-nvidia-vs-amd-only-one-deserves-your-money, live-semiconductors-sandisk-s-gross-margins-just-topped-nvidia-s-wall-street-sold-anyway, live-semiconductors-a-look-at-amd-amd-valuation-after-a-powerful-multi-period-share-price-run
...
References: NVDA, live-semiconductors-sandisk-s-gross-margins-just-topped-nvidia-s-wall-street-sold-anyway, live-semiconductors-a-look-at-amd-amd-valuation-after-a-powerful-multi-period-share-price-run, live-semiconductors-chai-ai-backed-by-coreweave-and-amd-hits-80m-arr-with-talks-of-2-4b-valuation
